#!/bin/bash
gcloud beta compute \
--project=euphoric-diode-254304 instances create instance-1 \
--zone=us-central1-a \
...
--scopes=https://www.googleapis.com/auth/de
...
s.com/auth/service.management.readonly,https://www.googleapis.com/auth/trace.append \
